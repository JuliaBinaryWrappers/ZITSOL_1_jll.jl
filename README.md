# `ZITSOL_1_jll.jl` (v0.1.2+0)

[![deps](https://juliahub.com/docs/ZITSOL_1_jll/deps.svg)](https://juliahub.com/ui/Packages/ZITSOL_1_jll/FL73L?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/096d77359ca3d1257ce6c8bb848e322eb5994080/Z/ZITSOL_1/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `ZITSOL_1_jll.jl` have been built from these sources:

* git repository: https://github.com/JuhaHeiskala/zitsol_mod.git (revision: `9e4c7d5ab9c65f1e96db698d5005cd2011dcd492`)

## Platforms

`ZITSOL_1_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `ZITSOL_1_jll.jl`:
